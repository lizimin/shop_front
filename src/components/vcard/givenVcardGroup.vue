<template>
  <div class="cpts-myvcard">
    ...
    <div class="empty-wrapper" v-show="!givenvcards.length">
    ...
    <div class="mycards-wrapper" v-show="givenvcards.length">
      <div class="content">
        <div class="box">
          <div>
            <div class="card-list">

              <div v-for="(item,index) in givenvcards" :key="index" class="card-item" :class="item.styleClass">
                <router-link :to=" `/giveVcard/${item.card_code}`">
                  <h3>{{item.sku.sku_use_rule}}</h3>
                  <p>{{item.sku.extra_data.short_des}}</p>
                  <div class="card-item_bottom">
                    <!-- <span>{{item.sku.exp_time_str}}</span> -->
                    <span class="count" v-if="item.Customer.cname">
                      <i>{{item.Customer.cname}}赠送</i>
                    </span>
                  </div>
                </router-link>
              </div>
